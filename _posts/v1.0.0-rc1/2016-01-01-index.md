...
~~~ html
<!--Sourcemap: //cdn.tmijs.org/js/0.0.29/tmi.js.map-->
<script src="//cdn.tmijs.org/js/0.0.29/tmi.js" integrity="sha384-exvKVmWtKcPGoyvSd7ceeT+v/CY3O9jqNBKLgriUds0y59JnAhUG22KZlJqdQnx5" crossorigin="anonymous"></script>
~~~

We do not recommend the use of the latest branch as your application could break if we introduce breaking changes.

~~~ html
<!--Sourcemap: //cdn.tmijs.org/js/latest/tmi.js.map-->
