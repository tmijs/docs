...
* `methods`: _Object_ - Resub methods \(such as Prime\)
...
* `channel`: _String_ - Channel name
* `username`: _String_ - Username
* `method`: _Object_ - Method used to subscribe
