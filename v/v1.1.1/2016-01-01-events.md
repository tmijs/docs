...
* [Names](2016-01-01-events.md#names) - Received the list of users of a channel.
...
Received the list of users of a channel.  
**Important:** This event will be sent multiple times on large channels.

Parameters:

* `channel`: _String_ - Channel name
* `users`: _Array_ - Users of the channel
